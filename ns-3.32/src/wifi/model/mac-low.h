...
public:
// Tests David
void ReserveMedium(Time duration, bool pauseTransmissions);
Time endOfTransmissionWindow = Seconds(0);
void setEndOfTransmissionWindow(Time endOfTransmissionWindow);
// void PauseTransmissions(Time duration, bool pauseTransmissions);
// void setAPPDUMaxTime(Time duration);
